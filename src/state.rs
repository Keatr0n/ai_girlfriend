...
pub struct State {
    ...
    pub user_mute: bool,
    pub is_editing: bool,
    pub is_hiding_think_tags: bool,
    pub is_only_responding_after_name: bool,
...
impl Default for State {
    fn default() -> Self {
        Self {
            ...
            user_mute: false,
            is_editing: false,
            is_hiding_think_tags: true,
            is_only_responding_after_name: false,
            time_since_name_was_said: None,
            text_input: None,
            llm_command: None,
